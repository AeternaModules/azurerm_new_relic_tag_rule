...
output "new_relic_tag_rules_azure_active_directory_log_enabled" {
  ...
  value       = { for k, v in azurerm_new_relic_tag_rule.new_relic_tag_rules : k => v.azure_active_directory_log_enabled }
}
output "new_relic_tag_rules_log_tag_filter" {
  ...
  value       = { for k, v in azurerm_new_relic_tag_rule.new_relic_tag_rules : k => v.log_tag_filter }
}
output "new_relic_tag_rules_metric_enabled" {
  ...
  value       = { for k, v in azurerm_new_relic_tag_rule.new_relic_tag_rules : k => v.metric_enabled }
}
output "new_relic_tag_rules_metric_tag_filter" {
  ...
  value       = { for k, v in azurerm_new_relic_tag_rule.new_relic_tag_rules : k => v.metric_tag_filter }
}
output "new_relic_tag_rules_monitor_id" {
  ...
  value       = { for k, v in azurerm_new_relic_tag_rule.new_relic_tag_rules : k => v.monitor_id }
}
output "new_relic_tag_rules_subscription_log_enabled" {
  ...
  value       = { for k, v in azurerm_new_relic_tag_rule.new_relic_tag_rules : k => v.subscription_log_enabled }
}
